...
int main()
{
    ...
    // ESTA LINEA DESPUES SE VA (SOLO ES PARA TESTING)
...
int hardcodearAlumnos(eAlumno alumnos[], int tam, int cantidad)
{
    ...
    eAlumno listaAuxiliar[] =
    {
        ...
        {20001, "Ana", 21, 'f', 6, 8, 7,{21, 5, 2013}, 0},
        {20002, "Alicia", 21, 'f', 5, 4, 4.5,{15, 5, 2017}, 0},
        {20003, "Miguel", 21, 'm', 6, 6, 6,{17, 7, 2016}, 0},
        {20004, "Gaston", 21, 'm', 2, 4, 3,{16, 3, 2019}, 0},
        {20005, "Amalia", 21, 'f', 2, 8, 4,{10, 2, 2015}, 0},
        {20006, "Sofia", 21, 'f', 10, 10, 10,{5, 5, 2014}, 0},
        {20007, "Diego", 21, 'm', 9, 8, 8.5,{24, 5, 2018}, 0},
        {20008, "Fernando", 21, 'm', 5, 6, 5.5,{20, 8, 2019}, 0},
        {20009, "Carolina", 21, 'f', 8, 8, 8,{19, 12, 2017}, 0}
